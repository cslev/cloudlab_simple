...
for i in range(1,7):
  ...
  # node.hardware_type = "m400" ##ARM - Eight 64-bit ARMv8 (Atlas/A57) cores at 2.4 GHz (APM X-GENE)
  node.hardware_type = "xl170" ##Intel x86_64 - 	Ten-core Intel E5-2640v4 at 2.4 GHz
  # node.hardware_type = "d6515"  ##AMD x86_64 -  AMD EPYC ROMTE, 32-cre AMD 7452 @ 2.35GHz
  #kube_doh.disk_image = 'urn:publicid:IDN+emulab.net+image+emulab-ops:DEB8-64-STD' #<-- does not work
  node.disk_image = 'urn:publicid:IDN+emulab.net+image+emulab-ops:UBUNTU18-64-STD'
  node.Site(str(key))

  #START the docker-based version - this init scripts install basic packages and docker subsystem to make it capable running containers as well
